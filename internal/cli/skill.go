...
func GenerateSkill() string {
	// Comments follow after two spaces instead of a shared alignment
	// column: padding every line to the longest command cost ~1.1KB of
	// pure spaces in a file agents pay tokens to load.
